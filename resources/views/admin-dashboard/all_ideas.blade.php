      ...
      <div class="row">
        <div class="col-12 col-12 col-md-12 col-lg-12">
          <div class="card card-shadow p-3">
            ...
            All Published Idea &nbsp;&nbsp;&nbsp;<span class="badge badge-purple badge-pill">{{ $all_idea_published}}</span>
            <div>
                ...
                <div class="enable-ideas-scrollable">
                  <ul class="list-unstyled recent-ideas-module pt-0 pb-1" v-for="(idea, index) in ideas" :key="index">
                    <div class="row">
                      ...
                      <div class="col-12 col-sm-12 col-md-4 col-lg-4 feature_column @if ($agent->isMobile()) text-center @endif"
                        @if (!$agent->isMobile()) style="display: flex;" @endif>
                        <div class="row">
                          <div class="col-12 col-sm-5 col-md-6 col-lg-6 " style="display:flex">
                            @if (!$agent->isMobile())
                              <a v-if="idea.is_piloted == 0" @click="makePiloted(idea.id)" class="view-more-button make_featured_idea_badge"
                                style="font-size: 11px;">Make Piloted</a>
                              <span v-else @click="makeNonPiloted(idea.id)" class="featured_idea_badge" style="font-size: 11px;">Piloted</span>
                            @else
                              <a v-if="idea.is_piloted == 0" @click="makePiloted(idea.id)" class="view-more-button make_featured_idea_badge"
                                style="font-size: 11px;">Make Piloted</a>
                              <span v-else @click="makeNonPiloted(idea.id)" class="featured_idea_badge" style="font-size: 11px;">Piloted</span>
                          ...
                          <div class="col-12 col-sm-5 col-md-6 col-lg-6 @if ($agent->isMobile()) text-center @endif"
                            @if (!$agent->isMobile()) style="display: flex;" @endif>
                            @if (!$agent->isMobile())
