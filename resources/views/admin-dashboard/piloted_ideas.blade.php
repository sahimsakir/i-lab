...
<div class="row pt-3 pb-3 pl-4 pr-4 admin-dashboard-right-section">
    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="col-12 col-12 col-md-12 col-lg-12">
            ...
            {{$idea_name}} &nbsp;&nbsp;&nbsp;<span class="badge badge-purple badge-pill">{{ $ideasCount }}</span>
            <div>
                ...
                <p v-if="dateField == ''">
                    Now Showing ( All ) Featured Data only
                </p>
                <p  v-else>
                    Now Showing 
                    (
            ...
            <div>
                ...
                <div class="enable-ideas-scrollable">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4 @if ($agent->isMobile()) mb-2 @endif"></div>
                        <div class="col-12 col-sm-8 col-md-8 col-lg-8 @if ($agent->isMobile()) text-center @endif"
